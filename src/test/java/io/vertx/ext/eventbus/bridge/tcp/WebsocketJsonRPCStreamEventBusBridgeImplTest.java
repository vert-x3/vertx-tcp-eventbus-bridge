...
public class WebsocketJsonRPCStreamEventBusBridgeImplTest {
  ...
  private final Handler<BridgeEvent<WebSocketBase>> eventHandler = event -> event.complete(true);
  ...
  public void before(TestContext should) {
    ...
    final Handler<WebSocketBase> bridge = JsonRPCStreamEventBusBridge.webSocketHandler(
        vertx,
