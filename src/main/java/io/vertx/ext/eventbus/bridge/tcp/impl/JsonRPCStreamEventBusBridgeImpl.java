...
public class JsonRPCStreamEventBusBridgeImpl implements JsonRPCStreamEventBusBridge {
  ...
  private void dispatch(NetSocket socket, String method, Object id, JsonObject msg, Map<String, MessageConsumer<?>> registry, Map<String, Message<JsonObject>> replies) {

    switch (method) {
      case "send":
        checkCallHook(
          () -> new BridgeEventImpl(BridgeEventType.SEND, msg, socket),
      ...
      case "register":
        checkCallHook(
          () -> new BridgeEventImpl(BridgeEventType.REGISTER, msg, socket),
      ...
      case "unregister":
        checkCallHook(
          () -> new BridgeEventImpl(BridgeEventType.UNREGISTER, msg, socket),
  ...
  private void unregister(NetSocket socket, Object id, JsonObject msg, Map<String, MessageConsumer<?>> registry, Map<String, Message<JsonObject>> replies) {
  ...
  private void register(NetSocket socket, Object id, JsonObject msg, Map<String, MessageConsumer<?>> registry, Map<String, Message<JsonObject>> replies) {
    final JsonObject params = msg.getJsonObject("params", EMPTY);
    final String address = params.getString("address");
    ...
    if (checkMatches(false, address)) {
      ...
      checkCallHook(
        () -> new BridgeEventImpl(BridgeEventType.REGISTERED, msg, socket),
        () -> {
          if (id != null) {
            // ack
            JsonRPCHelper.response(id, EMPTY, socket);
  ...
  private void publish(NetSocket socket, Object id, JsonObject msg, Map<String, MessageConsumer<?>> registry, Map<String, Message<JsonObject>> replies) {
    final JsonObject params = msg.getJsonObject("params", EMPTY);
    final String address = params.getString("address");
  ...
  private void send(NetSocket socket, Object id, JsonObject msg, Map<String, MessageConsumer<?>> registry, Map<String, Message<JsonObject>> replies) {
    final JsonObject params = msg.getJsonObject("params", EMPTY);
    final String address = params.getString("address");
